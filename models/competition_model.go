...
type Competition struct {
	...
	BinusianRegistrationFee    int             `db:"binusian_registration_fee" json:"binusianRegistrationFee"`
	NonBinusianRegistrationFee int             `db:"non_binusian_registration_fee" json:"nonBinusianRegistrationFee"`
	...
	FAQ                        json.RawMessage `db:"faq" json:"faq"`
